...
const ContactPage = () => {
    return (
        <>
            ...
            <div className="container flex flex-col lg:flex-row py-20">
                <div
                    className='w-4/5 h-auto flex gap-10 items-center justify-center flex-col bg-primary-50 shadow-lg rounded-lg'>
                    <div
